    ...
    public class GreaterThanOperator : Operator
    {
        ...
        internal override Literal Execute(IConstruct argument1, IConstruct argument2)
        {
            ...
            if (argument1Transformed is Number && argument2Transformed is Number)
                ...
                throw new InvalidOperationException(String.Format("Greater than operator requires arguments of type Number, TimeSpan or DateTime. Argument types are {0} {1}.", argument1Transformed.GetType().Name, argument2Transformed.GetType().Name));
        }
